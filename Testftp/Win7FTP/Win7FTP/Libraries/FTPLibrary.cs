...
namespace Win7FTP.Library
{
    ...
    public class FTPclient
    {
        ...
        FtpWebRequest UploadFTPRequest = null;
        ...
        public void uploadtest() {
            ...
            UploadFTPRequest = GetRequest("ftp://120.77.249.136/");
            FileInfo file = new FileInfo("C:/Windows/test.txt");
            UploadFTPRequest.Method = WebRequestMethods.Ftp.UploadFile;
            UploadFTPRequest.UseBinary = true;
            UploadFTPRequest.ContentLength = file.Length;
            int buffLength = 2048;
            ...
            try
            {
                //DownloadResponse = (FtpWebResponse)DownloadFTPRequest.GetResponse();
                DownloadResponse = (FtpWebResponse)UploadFTPRequest.GetResponse();
                //获取请求的响应流
        ...
        public bool Download(string sourceFilename, string localFilename, bool PermitOverwrite)
        {
            ...
            FileInfo fi = new FileInfo(localFilename);
            System.Diagnostics.Debug.WriteLine("fi： " + fi);
        ...
        FtpWebRequest DownloadFTPRequest = null;
        ...
        public bool Download(string sourceFilename, FileInfo targetFI, bool PermitOverwrite)
        {
            ...
            DownloadFTPRequest.Method = WebRequestMethods.Ftp.DownloadFile;
        ...
        public bool FtpDeleteDirectoryTest(string dirpath)
        {
